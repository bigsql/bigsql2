...
# 2013-06-26  | Farrukh       |    Added support for kerberos 5
# 2013-06-26  | Venkat B      |    Added support for building Hive FDW
# 2013-08-14  | Farrukh       |    Added support for new hadoop_fdw(formerly hive_fdw)
#                             |    Removed support for hive_fdw
#                             |    Removed support for java based hadoop_fdw 
# 2013-12-19  | Haroon        |    Added support for building pgTSQL
# 2015-10-01  | Farrukh       |    Added support for Orafce
# 2015-12-01  | Farrukh       |    Added support for pl/R, pl/V8
# 2015-12-20  | Farrukh       |    Added support for plprofiler, pldebugger
# 2015-12-22  | Farrukh       |    Added support for Orace_FDW, MySQL FDW
#                             |    TDS_FDW, Mongo_FDW      
# 2015-02-25  | Farrukh       |    Replace old JDBC based Cassandra FDW with 
#                             |    the CPP FDW.
#============================================================================
#
